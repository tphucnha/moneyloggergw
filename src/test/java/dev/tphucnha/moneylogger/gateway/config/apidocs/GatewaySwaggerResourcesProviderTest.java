package dev.tphucnha.moneylogger.gateway.config.apidocs;

import static dev.tphucnha.moneylogger.gateway.config.apidocs.GatewaySwaggerResourcesProvider.swaggerResource;
